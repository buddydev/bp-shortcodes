<?php
/**
 * BP Shortcodes Autoload Implementation.
 *
...
/**
 * Auto Loader for BP_Shortcodes.
 *
 * After registering this autoload function with SPL, the following line
 * would cause the function to attempt to load the BP_Shortcodes\Bar\Baz\Qux class
 * from /path/to/wp-content/plugins/bp-shortcodes/src/bar/baz/class-qux.php:
 *
 *      new BP_Shortcodes\Baz_Xyz\Qux;
 *  maps to /path/to/wp-content/plugins/bp-shortcodes/src/bar/baz-xyz/class-qux.php
...
class Autoloader {
	...
	/**
	 * Namespace root. eg. BP_Shortcodes\\(escaped slashes);
	 *
	 * @var string
	 */
